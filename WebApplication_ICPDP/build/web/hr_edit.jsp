    ...
    <body>
        <div class="container">
            ...
            <article  class="list">
                 ...
                 <h1 style="margin-left:  600px;">Điền thông tin nhân sự</h1>
                </br>
               
                <form action="hrEdit" method="POST">
                    <table style =" margin: auto auto;"border="1">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>    <input style =" padding: 12px 10px; "type="text" name="hrName" value="" /> </td>
                            </tr>
                            <tr>
                                <td style="line-height: 20px;">Kinh nghiệm làm việc</td>
                                <td>  <input style =" padding: 12px 10px;" type="text" name="hrDetail   " value="" />  </td>
                            </tr>
                            <tr>
                                <td style="line-height: 20px;">Ngày sinh</td>
                                <td>   <input style =" padding: 12px 10px;" type="text" name="hrDOB" value="" />  </td>
                            </tr>
                            <tr>
                                <td>Vị trí hiện tại</td>
                                <td>    <input style =" padding: 12px 10px;" type="text" name="hrJob" value="" /> 
                                </td>
                            </tr>
                    ...
                    <button style="background-color: #ff9933; /* Green */
                            ...
                            font-size: 16px;"
                            formaction="hrEdit" type="submit" value="">Thêm vào danh sách</button>
                </form>
