...
public class eventAdd extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Float budgetEvent = Float.parseFloat(request.getParameter("budgetEvent"));
        ...
        e.setPlaceEvent(placeEvent);
        e.setBudgetEvent(budgetEvent);
        e.setContentEvent(contentEvent);
