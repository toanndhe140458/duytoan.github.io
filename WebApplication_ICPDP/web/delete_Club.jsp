<%-- 
    ...
    Created on : Mar 29, 2021, 2:16:33 AM
    Author     : Nhat Anh PC
--%>
    ...
    <body>
        <div class="container">
            ...
            <article  class="list">
                ...
                <h1 style="margin-left:  600px;">Nhập ID CLB muốn xóa</h1>
                </br>

                <form action="clubdelete" method="POST">
                    ...
                    <button style="background-color: #ff9933; /* Green */
                            ...
                            font-size: 16px;"
                            formaction="clubdelete" type="submit" value="">Xóa thông tin</button>
                </form>
